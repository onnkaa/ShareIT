...
public class AdminMainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*boolean adminKontrol = false;
        firebaseUser = firebaseAuth.getInstance().getCurrentUser();
        String userUid = firebaseUser.getUid().toString().trim();
        System.out.println("emailllll " + userUid);

        String uid = "CWyeRFWsMmbDREMQMwbCIjHglwq1";
        if (userUid == uid){
            adminKontrol = true;

        }
        System.out.println("Admin kontrol" + adminKontrol);*/

        /*if (userEmail != adminMailAddress){
            menu.findItem(R.id.nav_adminPanel).setVisible(false);
        }else{
            menu.findItem(R.id.nav_adminPanel).setVisible(true);
        }*/
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            ...
            case R.id.nav_add_product:
                Intent intentToAddProduct = new Intent(AdminMainActivity.this,UploadActivity.class);
            ...
            case R.id.nav_logout:
                ...
                Intent intentToLogOut = new Intent(AdminMainActivity.this, LoginActivity.class);
                startActivity(intentToLogOut);
                finish();
                break;
            case R.id.nav_adminPanel:
                Intent intentToAdminPanel = new Intent(AdminMainActivity.this,AdminPanelActivity.class);
                startActivity(intentToAdminPanel);
                break;
            case  R.id.nav_profile:
                Intent intentToProfile = new Intent(AdminMainActivity.this,UserProfileActivity.class);
